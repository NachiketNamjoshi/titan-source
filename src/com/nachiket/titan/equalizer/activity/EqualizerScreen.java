...
import com.nachiket.titan.equalizer.preference.EqualizerPreference;
import com.nachiket.titan.equalizer.preference.SummariedListPreference;
 ...
 * @author alankila
 */
public final class EqualizerScreen extends PreferenceActivity {	
	...
	public SharedPreferences getSharedPreferences(String name, int mode) {
		return super.getSharedPreferences(Equalizer.SHARED_PREFERENCES_BASENAME + "." + getSubPage(), mode);
	}
