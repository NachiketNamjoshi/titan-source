package com.nachiket.titan.equalizer;
...
public class HeadsetService extends Service {
	public static final String NAME = "com.nachiket.equalizer.HEADSET_SERVICE";
	...
	public void onCreate() {
		...
		registerReceiver(preferenceUpdateReceiver, new IntentFilter("com.nachiket.titan.eualizer.UPDATE"));
	...
	protected void updateDsp() {
		...
		SharedPreferences preferences = getSharedPreferences("com.nachiket.titan.eualizer" + "." + mode, 0);
